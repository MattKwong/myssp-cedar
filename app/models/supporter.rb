class Supporter < ActiveRecord::Base
  attr_accessible :address1, :address2, :city, :phone, :phone_type,
                  ...
                  :desire_outreach, :desire_publicity, :desire_work_projects, :desire_web, :desire_plan_events,
                  ...
                  :skill_comp_prog_comments, :skill_const, :skill_electrical, :skill_food_prep, :skill_plan_events,
