...
ActiveRecord::Schema.define(:version => 20130310060051) do
  ...
  create_table "login_requests", :force => true do |t|
    ...
    t.string   "church_address1"
    t.string   "church_address2"
    t.string   "church_state"
    t.string   "church_zip"
    t.string   "church_office_phone"
    t.string   "church_office_fax"
    t.string   "address1"
    t.string   "address2"
    t.string   "city"
    t.string   "zip"
    t.string   "alt_phone_number"
    t.string   "alt_phone_number_type"
    t.string   "state"
  end
  ...
  create_table "supporters", :force => true do |t|
    ...
    t.boolean  "desire_plan_events"
    t.boolean  "skill_plan_events"
  end
